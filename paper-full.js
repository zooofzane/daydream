...
var paper = function(self, undefined) {
    ...
    self = self || require('../../Downloads/paperjs-v0.12.15/dist/node/self.js');
                ...
                function addOffsets(curve, end) {
                    var v = curve.getValues(),
                        ...
                        offset = Curve.getLength(v,
                            end && count ? roots[count - 1] : 0, !end && count ? roots[0] : 1);
    ...
    if (paper.agent.node) {
        require('../../Downloads/paperjs-v0.12.15/dist/node/extend.js')(paper);
    }
